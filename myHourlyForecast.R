...
source('~/Development/CommandLineWeatherR/getWeatherImage.R');
source('~/Development/CommandLineWeatherR/kelvinToFarenheit.R');
source('~/Development/CommandLineWeatherR/getCurrentLocation.R');
